...
def main() -> None:
    ...
    compute_dtype_name = args.compute_dtype or str(config.get("compute_dtype", "bfloat16"))
    param_dtype_name = args.param_dtype or str(config.get("param_dtype", "bfloat16"))
